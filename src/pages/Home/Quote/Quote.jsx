...
const Quote = () => {
    return (
        <div className='m-20 shadow-2xl flex gap-10 bg-gray-200 items-center p-10'>
            <div className='p-4 w-7/12'>
                <h1 className='text-4xl font-bold'>Unlock a World of Opportunities with WorldSpeak</h1>
