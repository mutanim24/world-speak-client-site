...
const CallToAction = () => {
    return (
        <div className='bg-cyan-700 my-5 p-6 md:p-14 grid md:grid-cols-3 space-y-5'>
            <div className='text-white md:space-y-3 border md:border-none p-4 hover:text-yellow-600'>
            ...
            <div className='text-white space-y-3 border md:border-none p-4 hover:text-yellow-600'>
